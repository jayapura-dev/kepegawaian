                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <ul class="breadcome-menu">
                            <li><a href="<?php echo base_url()?>tb">Tugas Belajar</a> <span class="bread-slash">/</span>
                            </li>
      ...
      <div class="col-lg-10">
        <div class="button-ad-wrap shadow-reset nt-mg-b-30">
          <div class="alert-title">
              ...
              <hr/>
              <form class="" action="<?php echo base_url()?>tb/delete_tgs_proses" method="post">
                <input type="hidden" name="id_tgs" value="<?php echo $detail['id_tgs'] ?>">
               ...
               <div class="form-group-inner">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <?php if($detail['dok_tgs'] != ''){ ?>
                          <img src="<?php echo base_url()?>images/tugas_belajar/<?php echo $detail['dok_tgs'] ?>" alt="" width="300px">
                        <?php } ?>
                    </div>
                </div>
               </div>
