      ...
      <div class="col-lg-12">
        <div class="all-form-element-inner">
          <div class="row">
              <div class="col-lg-12">
                  <div class="all-form-element-inner">
                      <form action="<?php echo base_url()?>pensiun/updatefile_pensiun_proses" method="post" enctype="multipart/form-data">
                         ...
                         <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <input type="file" name="dok_pensiun" id="xxdok_pegawai" class="form-control">
                                </div>
                            </div>
                          </div>
                          <div class="form-group-inner">
