                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <ul class="breadcome-menu">
                            <li><a href="<?php echo base_url()?>kpb">Pangkat</a> <span class="bread-slash">/</span>
                            </li>
        ...
        <div class="button-ad-wrap shadow-reset nt-mg-b-30">
          <div class="alert-title">
              ...
              <p class="alert alert-warning">
                ...
                Jika Anda Menhapus Item ini Pastikan Anda Mengupdate <strong>TMT Pangkat</strong> dan <strong>Pangkat</strong> Pejabat Bersangkutan, pada <a href="<?php echo base_url()?>pegawai" target="_blank">Tabel Master Pejabat</a><br/>
                Atau Lihat <a href="<?php echo base_url()?>pegawai/detail_pegawai/<?php echo $detail['id_pegawai'] ?>" target="_blank"> Detail Pejabat</a>
              </p>

              <hr/>
              <form class="" action="<?php echo base_url()?>kpb/delete_kpb_proses" method="post">
                <input type="hidden" name="id_kpb" value="<?php echo $detail['id_kpb'] ?>">
               ...
               <div class="form-group-inner">
                 <div class="row">
                     <div class="col-lg-2">
                         <label class="login2 pull-right pull-right-pro">Pangkat Lama</label>
                     </div>
                     <div class="col-lg-9">
                       <input name="pkt_lama" type="text" readonly="true" value="<?php echo $detail['pkt_lama'] ?>" class="form-control" />
                     </div>
                 </div>
               </div>
               <div class="form-group-inner">
                 <div class="row">
                     <div class="col-lg-2">
                         <label class="login2 pull-right pull-right-pro">Pangkat Baru</label>
                     </div>
                     <div class="col-lg-9">
                       <input name="pangkat" type="text" readonly="true" value="<?php echo $detail['pangkat'] ?>" class="form-control" />
                     </div>
                 </div>
               </div>
               <div class="form-group-inner">
               ...
               <div class="form-group-inner">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <?php if($detail['dok_kpb'] != ''){ ?>
                          <img src="<?php echo base_url()?>images/kpb/<?php echo $detail['dok_kpb'] ?>" alt="" width="300px">
                        <?php } ?>
                    </div>
                </div>
               </div>
