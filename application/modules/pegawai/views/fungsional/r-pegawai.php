                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">ASN Fungsional</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <div class="sparkline13-outline-icon">
                              <span><a href="<?php echo base_url()?>pegawai/create_asn_fungsional" title="Tambah Pegawai" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></a></i></span>
                          </div>
                        </div>
                    </div>
