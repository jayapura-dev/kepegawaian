            ...
            <div class="sparkline12-list shadow-reset mg-t-30">
              <div class="sparkline12-hd">
                  <div class="main-sparkline12-hd">
                      <h1><i class="fa fa-plus"></i> Tambah ASN Fungsional</h1>
                  </div>
              </div>
                                      ...
                                      <div class="form-group-inner">
                                       ...
                                       <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                  <input name="id_penempatan" type="hidden" value="2" class="form-control" />
                                                  <select name="id_pangkat" class="chosen-select form-control">
                                                       <option value="">-- Pilih --</option>
                                                        <?php
                                        ...
                                        <div class="form-group-inner">
                                           <div class="row">
                                               <div class="col-lg-2">
                                                   <label class="login2 pull-right pull-right-pro">Sekolah</label>
                                               </div>
                                               <div class="col-lg-6">
                                                   <select class="form-control" name="id_sekolah">
                                                       ...
                                                       foreach($sek as $p)
                                                       {?>
                                                       <option value="<?php echo $p['id_sekolah'] ;?>"><?php echo $p['nama_sekolah']; ?></option>
                                                       <?php
                                                       }?>
                                                   </select>
                                               </div>
